...
PASSTIME_CONVAR( tf_passtime_throwspeed_demoman, 800.0f, "" );
...
PASSTIME_CONVAR( streetpass_gibigao_time, 1.0f, "(FLOAT) Timeframe after getting the ball to score the ball while not blast jumping");
PASSTIME_CONVAR( streetpass_splash_reset, 0, "(BOOL) Should we swap teams after the ball was splashed");